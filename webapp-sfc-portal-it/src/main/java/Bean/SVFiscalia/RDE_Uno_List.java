...
public class RDE_Uno_List implements Serializable {
    ...
    public RDE_Uno_List(Integer id_trans, String token_valido, Date fecha_reporte, Integer codigo_mensaje, String descripcionmensaje, String codigotransaccion, Integer registrosprocesados) {
