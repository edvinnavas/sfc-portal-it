...
public class Dte_Lista implements Serializable {
    ...
    public Dte_Lista(Long id_dte, Integer ab_cliente, String cliente, Integer no_orden, String tipo_orden, Integer no_documento, Date fecha_documento, String enviado, String autorizado, String ambiente, String observacion) {
        this.id_dte = id_dte;
