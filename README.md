...
<!-- <dependency>
            <groupId>sfc.com</groupId>
            <artifactId>ApiFactMiscelanea</artifactId>
            <version>1.0</version>
            <scope>system</scope>
            <systemPath>${sisint.ApiFactMiscelanea}</systemPath>
        </dependency> -->

<!-- <sisint.ApiFactMiscelanea>C:\Users\enavas\Repositorios-GitHub\sfc-portal-it\api-rest-sfc-portal-it\src\main\resources\ApiFactMiscelanea-0.6.1.jar</sisint.ApiFactMiscelanea> -->
