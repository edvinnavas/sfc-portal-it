...
public class DTE_FEL_DETALLE implements Serializable {
    ...
    public String toString() {
        return "DTE_FEL_DETALLE{" + "id_dte=" + id_dte + ", tipo_registro=" + tipo_registro + ", id_detalle=" + id_detalle + ", cantidad=" + cantidad + ", id_unidad_medida=" + id_unidad_medida + ", precio=" + precio + ", porcentaje_descuento=" + porcentaje_descuento + ", importe_descuento=" + importe_descuento + ", importe_bruto=" + importe_bruto + ", importe_exento=" + importe_exento + ", importe_neto=" + importe_neto + ", importe_iva=" + importe_iva + ", importe_otros=" + importe_otros + ", importe_total=" + importe_total + ", producto=" + producto + ", descipcion=" + descipcion + ", id_tipo_venta=" + id_tipo_venta + '}';
    }
